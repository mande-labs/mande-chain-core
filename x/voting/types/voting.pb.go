...
type AggregateVoteCount struct {
	...
	IsAggregateVotesReceivedNegative bool   `protobuf:"varint,4,opt,name=isAggregateVotesReceivedNegative,proto3" json:"isAggregateVotesReceivedNegative,omitempty"`
}
...
func (m *AggregateVoteCount) GetIsAggregateVotesReceivedNegative() bool {
	if m != nil {
		return m.IsAggregateVotesReceivedNegative
	}
	return false
}
...
var fileDescriptor_a4ddf73ad3e922a0 = []byte{
	...
	,
}
...
func (m *AggregateVoteCount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.IsAggregateVotesReceivedNegative {
		i--
		if m.IsAggregateVotesReceivedNegative {
			dAtA[i] = 1
		} else {
...
func (m *AggregateVoteCount) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsAggregateVotesReceivedNegative", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IsAggregateVotesReceivedNegative = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipVoting(dAtA[iNdEx:])
			if err != nil {
