...
var (
	_ simapp.App              = (*MandeApp)(nil)
	_ servertypes.Application = (*MandeApp)(nil)
)

// MandeApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type MandeApp struct { //nolint: revive
	*baseapp.BaseApp
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".mande")
}

// NewMandeApp returns a reference to an initialized Mande.
func NewMandeApp(
	logger log.Logger,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig mandeappparams.EncodingConfig,
		...
		mandeante.HandlerOptions{
			HandlerOptions: ante.HandlerOptions{
				...
				TxFeeChecker: func(ctx sdk.Context, tx sdk.Tx) (sdk.Coins, int64, error) {
					...
					priority := mandeante.GetTxPriority(feeCoins)
...
func (app *MandeApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *MandeApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *MandeApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *MandeApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *MandeApp) ModuleAccountAddrs() map[string]bool {
...
// addresses.
func (app *MandeApp) BlockedModuleAccountAddrs() map[string]bool {
...
// LegacyAmino returns MandeApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *MandeApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns Mande's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *MandeApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Mande's InterfaceRegistry
func (app *MandeApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *MandeApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *MandeApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *MandeApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *MandeApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *MandeApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *MandeApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *MandeApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *MandeApp) RegisterTendermintService(clientCtx client.Context) {
